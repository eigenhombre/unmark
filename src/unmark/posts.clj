...
(defpost "Marginalia Hacks"
  ...
  (postbody
   (section "Marginalia Hacks"
     ...
     order I want them to appear. For example, if I wanted both " [:code "src"] "
     and " [:code "test"] " files in my output, and if I wanted
     " [:code "src/myproject/core.clj"] " to appear first, I would say"
...
(defpost
  ...
  (postbody
   (section "Communicating With Humans"
     (epigraph  "If nobody but me likes it, let it die."
                [:a {:href "http://www.informit.com/articles/article.aspx?p=1193856"} "Knuth"])
     (img "marg-printed")
     [:span
     ...
     understand it. "
     [[:a {:href "http://en.wikipedia.org/wiki/Literate_programming"} "Literate Programming"]
     ...
     ["Descendents and variants of WEB can be found in use
      ...
      Deer. "]
     [[:a
       {:href "http://web.archive.org/web/20090102151452/http://www.perl.com/pub/a/tchrist/litprog.html"}
